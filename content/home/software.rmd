...
* <img src = "/software/automultinomial/plotk2.png", width = "200", height = "200"> The <tt>automultinomial</tt> package, for regression models of spatially correlated discrete data.  [Vignette](/software/automultinomial/vignette.pdf) with detailed description and guide to use. Available for download on 
